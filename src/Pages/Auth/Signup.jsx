function Signup() {
    return (
        ...
        <section className="text-gray-600 body-font">
            <div className="flex flex-wrap items-center h-screen px-10  py-5 mx-auto">
                ...
                <form className="flex flex-col w-full p-8 mt-10 bg-gray-100 rounded-lg  lg:w-2/6 md:w-1/2 
                md:ml-auto md:mt-0">
                    ...
                    <button type="submit" className="mt-4 text-white bg-yellow-500 border-0 py-2 px-8 focus:outline-none hover:bg-yellow-600 rounded text-lg">
                        Create Account
                    </button>
